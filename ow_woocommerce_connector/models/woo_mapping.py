...
class WooProductMapping(models.Model):
    ...
    _sql_constraints = [
        ('_woo_product_unique','unique(instance_id, woo_id)','This WooCommerce product is already mapped for this instance.'),
        ]
...
class WooPartnerMapping(models.Model):
    ...
    _sql_constraints = [
        ('_woo_partner_unique','unique(instance_id, woo_id)','This WooCommerce customer is already mapped for this instance.'),
    ]
...
class WooSaleOrderMapping(models.Model):
    ...
    _sql_constraints = [
        ('_woo_order_unique','unique(instance_id, woo_id)','This WooCommerce order is already mapped for this instance.'),
    ]
