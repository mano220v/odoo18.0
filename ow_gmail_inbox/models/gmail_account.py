...
class GmailVault(models.Model):
    ...
    _sql_constraints = [
        ("unique_account", "UNIQUE(account_id)", "Only one credential set is allowed per account."),
    ]
...
class GmailAccount(models.Model):
    ...
    _sql_constraints = [
        ("unique_user", "UNIQUE(user_id)", "Each Odoo user can connect one Gmail account."),
    ]
